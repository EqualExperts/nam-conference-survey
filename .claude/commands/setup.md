...
>
> **Note**: If your engineering team has already documented technical architecture or tech stack information, you can add those files directly to `knowledge/product/` or reference them if they're elsewhere in the repository. I'll be able to read them automatically."
...
Ask these questions and populate `knowledge/product/product-overview.md`:
...
> "Great! I'll create your product overview now. You can add more detail to `knowledge/product/product-overview.md` anytime."
...
Ask these questions and populate `knowledge/product/target-users.md`:
...
After collecting responses, say:
> "Perfect! I'll create your target users file now. You can add more personas or detail to `knowledge/product/target-users.md` anytime."
...
Ask these questions and populate `knowledge/product/competitive-landscape.md`:
...
Say:
> "Now let's talk about technical context. **Important**: If your engineering team has already documented architecture, tech stack, or technical constraints, you can skip this and just point me to those files or add them to `knowledge/product/` directly."
...
- Say: "Great! I'll reference that documentation. You can also copy key files to `knowledge/product/technical-context.md` if you want me to always have quick access."
- Skip technical questions

**If NO**:
Ask these questions and populate `knowledge/product/technical-context.md`:
...
**If YES**: Ask them to list 3-5 key terms and their definitions, then populate `knowledge/product/glossary.md`

**If NO**: Say "No problem! You can add terms to `knowledge/product/glossary.md` as they come up during discovery."
...
> "**Setup Complete!**
>
> I've created your product context files in `knowledge/product/`. You can review and edit them anytime.
>
> ### What you can do now:
>
...
>    - Review files in `knowledge/product/` and add detail
>    - If you have existing technical docs, copy them to `knowledge/product/`
...
1. **Use the templates** in `knowledge/product/` as a base
...
- Say: "Totally fine! You can manually edit the context files in `knowledge/product/` whenever you're ready. Want to jump straight to `/iter` to start discovery?"

**If user has existing documentation**:
- Say: "Perfect! You can copy those files directly into `knowledge/product/` or just point me to them and I'll reference them. This interview is optional if you already have good docs."
